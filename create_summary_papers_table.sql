...
CREATE TABLE IF NOT EXISTS summary_papers (
    ...
    beginner_summary TEXT NOT NULL, -- Summary for beginners/general audience (150-200 words)
    intermediate_summary TEXT NOT NULL, -- Summary for intermediate/post-university level (150-200 words)
